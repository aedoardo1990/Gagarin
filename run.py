...
delprint("This quiz game was created for all the people enthusiastic and")
delprint("nostalgic about Soviet Union, for those who are interested to know")
delprint("some of its great achievements, culture and controversies.")
delprint("Churchill defined Russia as 'a riddle, wrapped in a mystery,")
delprint("inside an enigma'. Perhaps no better quote could define as well")
delprint("the history of USSR - of which Russia is its direct inheriter.\n")
delprint("Do you want to be our comrade?\n")
delprint("If yes, please enter a name to start the quiz and get ready")
delprint("to revive the peaks of USSR glory.\n")
